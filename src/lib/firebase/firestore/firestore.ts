...
function applyQueryFilters(q: any, { category, city, price, sort }: any) {
  if (category) {
...
export function getRestaurantsSnapshot(cb: any, filters = {}) {
...
export function getRestaurantSnapshotById(restaurantId: string, cb: any) {
  if (!restaurantId) {
    console.log("Error: Invalid ID received: ", restaurantId);
    return;
  }
